...
## Project overview
This is a database project I made where I grabbed 10 years of temperature data from places in and near the San Francisco Bay Area in California and made it accessible to an AI agent.
